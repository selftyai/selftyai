/**
 * Add parentMessageId to the Message model
 */
...
export const stores = {
  ...
  messages:
    '++id, content, role, conversationId, parentMessageId, modelId, waitingTime, responseTime, promptTokens, completionTokens, totalTokens, finishReason, error, createdAt, updatedAt',
